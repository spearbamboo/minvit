...
# torch.distributed 관련 코드는 DP 환경에서는 사용하지 않으므로
# 관련 함수들은 그대로 남겨두되, init_distributed_mode()에서 초기화를 건너뜁니다.
...
def is_dist_avail_and_initialized():
    # In DP mode, distributed is not initialized.
    return False
...
class MetricLogger(object):
    ...
    def synchronize_between_processes(self):
        # No synchronization needed in DP mode.
        pass
...
def init_distributed_mode(args):
    ...
    """
    print("Running in DataParallel (DP) mode. Distributed initialization is skipped.")
    args.rank = 0
    args.world_size = 1
    args.gpu = 0
    # Optionally, set MASTER_ADDR and MASTER_PORT for compatibility.
